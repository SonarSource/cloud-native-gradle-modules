...
val goLicenseGenerationConfig = extensions.findByType<GoLicenseGenerationConfig>() ?: extensions.create<GoLicenseGenerationConfig>("goLicenseGenerationConfig")
...
fun transformGoLicenseOutputToDesiredLicenseStructure(
    ...
    if (!Files.exists(generatedDirectory) || !Files.isDirectory(generatedDirectory)) {
